...
- [ ]  `r advdate(dayone, 3, topic)`
  - Finish Lab 1 and 2 by `r startweek`:  `r advdate(dayone, 3, assignment=startweek)`
...
- [ ] `r advdate(dayone, 5, topic)`
  - Finish Lab 3 and 4  by `r startweek`:  `r advdate(dayone, 5, assignment=startweek)`
...
- [ ] `r advdate(dayone, 7, topic)`
  - Finish Lab 5 and 6 by `r startweek`:  `r advdate(dayone, 7, assignment=startweek)`
...
- [ ] `r advdate(dayone, 9, topic)`
  - Finish Lab 7 and 8 by `r startweek`:  `r advdate(dayone, 9, assignment=startweek)`
...
- [ ] `r advdate(dayone, 11, topic)`
    - Finish Lab 9 and 10 by `r startweek`:  `r startweek`:  `r advdate(dayone, 11, assignment=startweek)`
...
- [ ] `r advdate(dayone, 13, topic)`
  `r if(params$labs>=13) paste0(" - Finish Lab 13 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
    ...
    `r if(params$labs>=11) paste0(" - Finish Lab 11 by ",startweek,": ",advdate(dayone, 13, assignment=startweek))`
    - Finish portfolio piece 6 by `r advdate(dayone, 13, assignment=startweek)`
...
- [ ] `r advdate(dayone, 15, topic)`
  - Finish portfolio piece 9 and 10 by `r startweek`:  `r advdate(dayone, 15, assignment=startweek)`
